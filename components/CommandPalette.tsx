...
const COMMANDS: Command[] = [
  ...
  { id: "focus", label: "Currently Building", hint: "focus", group: "Navigate", keywords: "now building aquasentinel personal ai agent browser status focus", icon: <Target {...IC} />, run: () => execInTerminal("focus") },
