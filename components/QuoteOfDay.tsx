...
export default function QuoteOfDay() {
  ...
  return (
    ...
    <div data-quote-of-day="" className="pointer-events-none fixed inset-x-3 bottom-[5.5rem] z-50 mx-auto max-w-[400px] sm:inset-x-auto sm:right-10 sm:bottom-10 sm:mx-0 sm:w-[92vw] sm:max-w-sm">
      <div
