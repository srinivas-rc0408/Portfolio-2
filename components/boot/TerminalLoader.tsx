...
export const TerminalLoader: React.FC<TerminalLoaderProps> = ({
  ...
  return (
    <div
      className={`terminal-loader relative w-[90%] max-w-[400px] overflow-hidden rounded border border-gray-700 bg-gray-950 p-6 pt-8 font-mono text-base shadow-[0_0_45px_rgba(56,189,248,0.28)] ${className}`}
    >
      ...
      <div className="boot-type mt-2 inline-block whitespace-nowrap border-r-2 font-bold text-sky-400">
        {text}
      </div>
    </div>
  );
