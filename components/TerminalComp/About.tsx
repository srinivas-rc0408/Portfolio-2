...
const CodeIcon: React.FC = () => (
  <svg
    ...
    className="w-6 h-6 sm:w-8 sm:h-8 mb-1.5 sm:mb-2 text-white group-hover:text-white transition-all duration-150 group-hover:scale-110"
  >
        ...
        <div className="space-y-8 sm:space-y-12">
            ...
            <div className="ml-3 sm:ml-6 border-l-2 border-cyan-800/30 pl-3 sm:pl-6">
              ...
              <div className="mt-4 sm:mt-6 flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-2 py-1 sm:px-3 bg-cyan-900/30 border border-cyan-800/50 rounded-full text-white text-xs sm:text-sm font-mono hover:bg-cyan-800/30 transition-colors duration-150"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div className="group border border-cyan-800/40 bg-gradient-to-br from-cyan-900/20 to-black/80 backdrop-blur-sm p-3 sm:p-5 rounded-xl hover:border-[var(--accent)] transition-all duration-150 hover:scale-[1.02] sm:hover:scale-105 hover:shadow-2xl relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-150"></div>
                <div className="relative z-10">
                  ...
                  <p className="text-gray-400 text-sm sm:text-base leading-relaxed group-hover:text-gray-300 transition-colors duration-150">
